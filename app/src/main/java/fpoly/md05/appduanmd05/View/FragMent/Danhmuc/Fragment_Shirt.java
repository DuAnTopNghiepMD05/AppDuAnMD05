...
public class Fragment_Shirt extends Fragment implements SanPhamView {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view =  inflater.inflate(R.layout.fragment__shirt, container, false);
        InitWidget();
        Init();
        InitSanPham();
        return view;
    ...
    private void InitWidget() {
        rcvSP = view.findViewById(R.id.frgShirt_rcvShirt);
    }
    ...
    public void getDataSanPham(String id, String tensp, Long giatien, String hinhanh, String loaisp, String mota, Long soluong, String kichco, Long type, String mausac) {
        ...
        sanPhamAdapter = new SanPhamAdapter(getContext(), arr_sp, 2);

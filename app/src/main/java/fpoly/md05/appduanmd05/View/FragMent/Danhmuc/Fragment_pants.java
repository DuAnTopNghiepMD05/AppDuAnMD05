...
public class Fragment_pants extends Fragment implements SanPhamView {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view =  inflater.inflate(R.layout.fragment_pants, container, false);
        InitWidget();
        Init();
        InitSanPham();
        return view;
    ...
    private void InitWidget() {
        rcvSP = view.findViewById(R.id.frgPant_rcvPant);
    }
